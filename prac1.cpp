...
int count_leaf_nodes(node *current)
{
    if (current == nullptr)
            return 0;
...
int count_d1_nodes(node *current)
{
    if (current == nullptr)
            return 0;

        int left_count = count_d1_nodes(current->left);
        int right_count = count_d1_nodes(current->right);
...
int count_d2_nodes(node *current)
{
        if (current == nullptr)
            return 0;

        int left_count = count_d2_nodes(current->left);
        int right_count = count_d2_nodes(current->right);
